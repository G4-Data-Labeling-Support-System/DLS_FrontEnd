          ...
          <div className="w-full max-w-md relative z-10">
            <div className="login-card p-8 rounded-2xl border border-violet-500/20">
              ...
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="glass-input rounded-lg flex items-center px-4 transition-all group">
                    ...
                    <button
                      ...
                      className="ml-2 text-gray-500 hover:text-violet-400 transition-colors focus:outline-none"
                    >
                ...
                <button
                  disabled={isLoading}
                  className="w-full py-3.5 bg-gradient-to-r from-violet-600 to-fuchsia-600 rounded-lg font-bold text-sm tracking-wider shadow-[0_0_20px_rgba(139,92,246,0.3)] hover:shadow-[0_0_30px_rgba(217,70,239,0.5)] transition-all text-white flex items-center justify-center gap-2 group mt-2 hover:scale-[1.01] active:scale-[0.99] cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                  type="submit"
                >
