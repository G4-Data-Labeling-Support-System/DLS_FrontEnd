      ...
      <div className={themeClasses.layouts.container}>
        <div className={themeClasses.layouts.gridCols3}>
          ...
          >
            ...
            <div
              className={`mt-auto pt-8 flex items-center gap-2 font-bold text-sm tracking-widest uppercase opacity-0 group-hover:opacity-100 transition-opacity`}
            >
          ...
          >
            ...
            <div
              className={`mt-auto pt-8 flex items-center gap-2 ${themeClasses.text.fuchsia} font-bold text-sm tracking-widest uppercase opacity-0 group-hover:opacity-100 transition-opacity`}
            >
