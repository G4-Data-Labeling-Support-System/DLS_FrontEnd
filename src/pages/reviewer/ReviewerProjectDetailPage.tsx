...
export default function ReviewerProjectDetailPage() {
  ...
  if (loading && !project) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <span className="mt-4 text-violet-400 font-mono">Loading Project Details...</span>
      </div>
    )
  }
  ...
  return (
    <div className="p-6 animate-fade-in relative overflow-hidden min-h-screen">
      ...
      {/* Tabs Menu */}
      {projectId && <ReviewerProjectTabs projectId={projectId} activeTab="detail" />}
        ...
        <div className="bg-[#1A1625]/60 backdrop-blur-md border border-violet-500/20 rounded-2xl overflow-hidden shadow-xl flex flex-col h-full min-h-[400px]">
          <div className="w-full flex items-center justify-between px-6 py-4 border-b border-white/5 bg-[#231e31]/60">
            <div className="flex items-center gap-3">
              ...
              <span className="font-semibold text-white text-base font-display">Review Guidelines</span>
            </div>
