...
export const ActivityFeed: React.FC<ActivityFeedProps> = ({ logs, loading }) => {
  const getActionIcon = (action: string) => {
    ...
    if (act.includes('LOGOUT')) return <LogoutOutlined className="text-gray-500" />
  ...
  const getActionColor = (action: string) => {
    ...
    return 'bg-white/5 text-gray-500 border-gray-300'
  }

  if (loading && logs.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-4 glass-panel rounded-2xl border border-gray-200">
  ...
  return (
    <Card className={`${themeClasses.cards.glass} border-gray-200 h-full`} bodyStyle={{ padding: '1.5rem', height: '100%' }}>
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-xl font-bold text-[#111] tracking-tight">System Activity</h3>
            ...
            {logs.map((log, index) => (
              ...
              >
                <div className="flex flex-col gap-2 group">
                  ...
                  <div className="p-3 bg-white/5 rounded-xl border border-gray-200 hover:border-gray-300 transition-all group-hover:bg-white/10">
                    ...
                    {log.entityName && (
                      <div className="mt-2 flex items-center gap-2">
                        ...
                        <Tag className="m-0 text-[10px] bg-black/40 border-gray-200 text-violet-400 font-mono">
