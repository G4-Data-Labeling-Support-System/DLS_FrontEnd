...
export default function ProfilePage() {
    ...
    return (
        <div className="max-w-2xl mx-auto py-10 pb-32">
            ...
            <div className={`login-card p-8 rounded-2xl border ${themeClasses.borders.violet20} relative`}>
                {/* Background glow for the form card */}
                <div className={`absolute inset-0 ${themeClasses.effects.gridMesh} opacity-10 pointer-events-none rounded-2xl`}></div>
                <Form
                    form={form}
                    layout="vertical"
                    onFinish={onFinish}
                ...
                >
                    ...
                    <Form.Item
                        label={<span className={`text-xs font-medium ${themeClasses.text.secondary} uppercase tracking-wider pl-1`}>Full Name</span>}
                        name="fullName"
                    ...
                    >
                        <Input
                            ...
                            prefix={<UserOutlined className="text-white opacity-80 drop-shadow-[0_0_5px_rgba(255,255,255,0.3)]" />}
                        />
                    </Form.Item>

                    <Form.Item
                        label={<span className={`text-xs font-medium ${themeClasses.text.secondary} uppercase tracking-wider pl-1`}>Phone Number</span>}
                        name="phone"
                    >
                        <Input
                            size="large"
                            className="glass-input"
                            prefix={<PhoneOutlined className="text-white opacity-80 drop-shadow-[0_0_5px_rgba(255,255,255,0.3)]" />}
                        />
                    </Form.Item>
            ...
            <div className={`login-card p-8 mt-10 rounded-2xl border ${themeClasses.borders.violet20} relative`}>
                <div className={`absolute inset-0 ${themeClasses.effects.gridMesh} opacity-10 pointer-events-none rounded-2xl`}></div>
                ...
                >
                    <Form.Item
                        label={<span className={`text-xs font-medium ${themeClasses.text.secondary} uppercase tracking-wider pl-1`}>Current Password</span>}
                    ...
                    <Form.Item
                        label={<span className={`text-xs font-medium ${themeClasses.text.secondary} uppercase tracking-wider pl-1`}>New Password</span>}
                        name="newPassword"
                    >
                        <Input.Password
                            size="large"
