      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 flex flex-col gap-4">
          <div className="glass-panel rounded-2xl p-6 flex flex-col gap-4 border border-white/5">
            ...
            <DetailItem label="Assignment ID" value={task.assignmentId || 'N/A'} isMono />
            <DetailItem label="Task Type" value={task.taskType || 'N/A'} isCapitalize />
            <DetailItem label="Completed / Total" value={`${task.completedItems || 0} / ${task.totalItems || 0}`} />
            <DetailItem
              label="Review Status"
              value={task.reviewStatus ? task.reviewStatus.replace('_', ' ') : 'N/A'}
              isCapitalize
            />
                      ...
                      <tr
                        ...
                        onClick={() =>
                          navigate(`/annotator/task/${task.taskId || task.id}/annotate`, {
                            state: { startIndex: index, assignmentId: task.assignmentId || assignmentId }
                          })
                        }
                      >
