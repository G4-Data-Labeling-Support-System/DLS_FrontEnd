...
export const ApproveModal: React.FC<ApproveModalProps> = ({ open, onCancel, onConfirm, confirmLoading }) => {
    return (
        <Modal
            open={open}
            onCancel={onCancel}
        ...
        >
            <div className="p-6 text-center">
                ...
                <Title level={4} className="!text-white !mb-2 font-display">Approve Review?</Title>
