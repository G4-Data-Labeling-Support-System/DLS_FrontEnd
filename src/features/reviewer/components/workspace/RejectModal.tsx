...
export const RejectModal: React.FC<RejectModalProps> = ({ open, onCancel, onConfirm, confirmLoading }) => {
                        ...
                        <Row gutter={[12, 12]}>
                            {ERROR_TYPES.map(type => (
                                <Col span={12} key={type}>
                                    <div className={`p-3 rounded-lg border transition-all cursor-pointer ${feedback.includes(type) ? 'bg-red-500/10 border-red-500/50' : 'bg-[#231e31] border-gray-800 hover:border-gray-700'}`}>
