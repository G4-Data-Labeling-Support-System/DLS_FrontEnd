        ...
        items={[
          {
            ...
            children: (
              <div className="h-full overflow-y-auto px-1 custom-scrollbar pb-4 space-y-4">
                  ...
                  <div className="bg-[#231e31] rounded-xl p-3 border border-gray-700 mt-2">
                    <div className="flex items-center gap-3 mb-3">
                      <Avatar
                        size="small"
                        icon={<UserOutlined />}
                        className="bg-gradient-to-br from-violet-500 to-fuchsia-500 shadow-md"
                      />
                      <div>
                        <Text className="text-white block text-xs font-medium">
                          {annotator.name}
                        </Text>
                ...
                <div>
                  <Text className="text-gray-500 text-[10px] font-bold uppercase tracking-wider mb-2 block sticky top-0 bg-[#1A1625] py-1 z-10">
                  ...
                  <div className="space-y-2">
                    {annotations.map((obj) => (
                      <div
                        key={obj.id}
                        className="group p-2 hover:bg-white/5 rounded-lg transition-colors border border-transparent hover:border-white/5 bg-[#231e31]/50"
                      >
