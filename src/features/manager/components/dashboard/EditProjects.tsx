...
export const EditProject = () => {
    ...
    return (
        <div className="w-full max-w-3xl mx-auto pb-10">
            {/* Header / Nút Back */}
            <Space className="mb-6 cursor-pointer text-gray-400 hover:text-white transition-colors" onClick={() => navigate(-1)}>
                <ArrowLeftOutlined />
                <span>Quay lại</span>
            </Space>

            <Title level={3} className="!text-white !mb-6 !font-display">Chỉnh sửa Dự án</Title>
