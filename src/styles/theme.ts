...
export const theme = {
    ...
    gradients: {
        ...
        radialViolet: 'radial-gradient(circle at center, rgba(139, 92, 246, 0.15) 0%, rgba(15, 14, 23, 1) 70%)',
        radialVioletLight: 'radial-gradient(circle at center, rgba(139, 92, 246, 0.1) 0%, rgba(15, 14, 23, 1) 70%)',
    },
...
export const { colors, gradients, shadows, borders, glass, fonts, spacing, borderRadius, transitions } = theme;
