...
export const themeClasses = {
    ...
    // Gradients
    gradients: {
        radialViolet: 'bg-[radial-gradient(circle_at_center,_rgba(139,92,246,0.15)_0%,_rgba(15,14,23,1)_70%)]',
    },
    ...
    // Button Classes
    buttons: {
        primary: 'px-4 py-2 bg-gradient-to-r from-violet-600 to-fuchsia-600 rounded-lg text-white font-medium shadow-[0_0_20px_rgba(139,92,246,0.3)] hover:shadow-[0_0_30px_rgba(139,92,246,0.5)] transition-all duration-300',
        secondary: 'px-4 py-2 bg-white/5 border border-violet-500/20 rounded-lg text-gray-300 hover:text-white hover:bg-violet-500/10 hover:border-violet-500/40 transition-all duration-300',
        ghost: 'px-4 py-2 text-gray-400 hover:text-white hover:bg-white/5 rounded-lg transition-all duration-300',
    },
    ...
    // Input Classes
    inputs: {
        glass: 'glass-input rounded-lg px-4 py-3 text-white placeholder-gray-600 focus:ring-0 focus:outline-none',
