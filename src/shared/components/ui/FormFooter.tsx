...
export const FormFooter: React.FC<FormFooterProps> = ({
  ...
  return (
    <div
      className={`mt-12 pt-6 border-t ${themeClasses.borders.white10} flex items-center justify-between`}
    >
      <div className="flex items-center gap-4">
        ...
        <span
          className={`${themeClasses.text.tertiary} uppercase text-xs tracking-widest hidden md:inline-block`}
        >
